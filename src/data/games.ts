    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: '正义之怒' },
          { name: '索拉斯塔' },
          { name: '骑马与砍杀系列', hours: '500+', comment: '骑马与砍杀2的经济系统以经济专家作为顾问团队操刀设计。这个系统十分仿真，复杂。但核心原则是商品在生产和消费的链条中循环往复，实现经济发展流动。核心的生产主体是村庄，村庄的村民每天会生产各种物品运往城镇。消费主体是城镇，在城镇里虽然也会生产各种工艺品，但是其主要作用是商队和玩家在这里完成消费，使生产和消费的链路跑通，产生经济发展。因为骑马与砍杀是领兵作战游戏，玩家在这里没有办法当农民，因此玩家一般通过二手途径获得金钱。在前期主要表现为击败强盗。后期表现为击败敌国领主，或者从自己的封地城镇收税。玩家在这个系统中通过给军队开薪酬，在城镇中购买食物，武器，装备，舰船等方式将钱消费。这个经济系统十分拟真，服务于骑马与砍杀拟真军旅生活的特性。很考验玩家前期的队伍控制和行动决策。而且商品会随供需关系变动，使这个经济系统具有弹性，能够长期维持动态稳定，是十分仿真的经济系统设计。' },
      ...
      },
      {
        ...
        items: [
          { name: '博德之门3', hours: '200+', comment: '博德之门3核心的系统脱胎于DND 5E的D20系统，这个系统经过市场验证，其核心优点就是富有特色，高度凝练和统一，以一颗最大点数20的骰子决定游戏中几乎所有行动的判定。但我觉得博德之门3能更加出众的原因就是把这套电子化的系统跟游戏结合的很好，实时剧情演出的表现力强，引擎的特殊调教和文本的多样性让交互性强，综合来看那种"在经历自己的故事的"味道非常足。' },
